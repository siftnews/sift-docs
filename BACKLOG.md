...
- [G] develop→main 동기화 (사람) — PR #2가 develop으로 병합됨, main ff 병합 + push (2026-07-06)
- [G] `develop` 브랜치 삭제 (사람) — 로컬·원격 모두 (2026-07-06 로컬 부활), GitHub 기본 브랜치 = main 확인 (D-012)
...
- (대기) M1-2 `[feature] Source 도메인 모델` 발행 → 구현 단계 분해
