...
> 원본이 다른 곳에 있는 것은 링크만 둔다 — 아키텍처 결정은 [DECISIONS](../adr/DECISIONS.md), ERD·배치 설계는 [MVP-DESIGN](https://github.com/siftnews/sift-api/blob/main/docs/MVP-DESIGN.md), 개발 절차는 [HARNESS](./HARNESS.md).
