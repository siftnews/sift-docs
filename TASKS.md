...
- [x] **#4 `[feature] Source 도메인 모델`** (M1-2) — PR #5로 develop 병합 완료 (2026-07-08)
...
- [x] **#8 `[feature] CrawlSources 유스케이스`** (M1-3) — PR #9로 develop 병합 완료 (2026-07-11)
...
- [~] **#10 `[feature] Source 영속 어댑터`** (M1-4) — 코드 구현 완료, PR 대기
